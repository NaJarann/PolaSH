...
/*
Sépare la chaine de caractère "cmd_line" de taille "size_line" en n sous-chaines délimitées par "separator".
*/
int nb_separators(char *cmd_line, int size_line, char separator);
/*
Compte le nombre d'occurrences du caractère "separator" dans la chaine de caractère "cmd_line" de longueur "size_line"
*/
